...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.providedit'
        db.add_column(u'profile_customuser', 'providedit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.providedit'
        db.delete_column(u'profile_customuser', 'providedit')
